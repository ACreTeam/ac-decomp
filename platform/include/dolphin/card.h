/* Shadow: replaces include/dolphin/card.h for arm64.
 * The original sub-headers use 'long' for all parameters (64-bit on arm64).
 * This shadow consolidates all declarations with correct fixed-width types. */
...
typedef struct CARDStat {
    ...
    u32  time;          /* seconds since 2000-01-01 */
    u8   gameName[4];
    u8   company[2];
    u8   bannerFormat;
    u32  iconAddr;
...
/* Private internal API (normally in __card.h) */
